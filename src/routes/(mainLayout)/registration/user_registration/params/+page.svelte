    ...
    <div class="form-container">
            <form bind:this={form}>
                <div class="name-container">
                    ...
                    <input  bind:this={inputWeight} class="text-14s" type="number" name="weight" maxlength="6" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" placeholder={user.params.weight.length > 0 ? user.params.weight[user.params.weight.length - 1].weight : ''} />
                </div>
