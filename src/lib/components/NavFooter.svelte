<script>
    export let trainingsACtive;
    export let targetsACtive;
...
<div class="footer__nav">
    <a href="/trainings" class="footer__nav-item">
        <div class="footer__icon-container {trainingsACtive ? '__active' : ''}">
        ...
        <div class="footer__text text-12s {trainingsACtive ? 'c-blue' : 'c-dark-gray'}">Тренировки</div>
    </a>
    <a href="/targets" class="footer__nav-item">
        <div class="footer__icon-container {targetsACtive ? '__active' : ''}">
        ...
        <div class="footer__text text-12s c-dark-gray {targetsACtive ? 'c-blue' : 'c-dark-gray'}">Цели</div>
    </a>
    <a href="/profile" class="footer__nav-item">
        <div class="footer__icon-container {profileACtive ? '__active' : ''}">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
        ...
        <div class="footer__text text-12s c-dark-gray {profileACtive ? 'c-blue' : 'c-dark-gray'}">Профиль</div>
    </a>
</div>
